...
class _ExamenPaciente extends State<ExamenPaciente> {
  ...
  final TextEditingController ocupation_controller =
      new TextEditingController();
  final TextEditingController milesdep_controller = new TextEditingController();
  final TextEditingController monedasde_controller =
      new TextEditingController();
  ...
  void _handleSubmitted() {
    if (_department == null ||
        ...
        _monthOfYear == null ||
        _year == null ||
        _contructionElement == null ||
        _town == null ||
        _beachElement == null ||
        _milesDePesos == null ||
        _monedasDe50 == null ||
        _restarle == null) {
      showInSnackBar("Porfavor llene todos los campos!");
    } else {
      ...
      //Memory Checks
      if (birth_fromDate.toIso8601String().split("T")[0] ==
          fechaNacimiento.split('T')[0]) {
        memoryScore -= 0.6;
      }
      if (_department == departamentoNacimiento) {
        memoryScore -= 0.6;
      }
      ...
      //judge Checks
      if (actual_fromDate.toIso8601String().split("T")[0] ==
      ...
      Navigator.of(context).push(new MaterialPageRoute(
          builder: (BuildContext context) => new informante.ExamenInformante(
              widget.googleId, memoryScore, judgeScore, orientationScore)));
    }
  }
  ...
  String month(int i) {
    if (i == 01) {
      return _monthsOfYear[0];
    }
    if (i == 02) {
      return _monthsOfYear[1];
    }
    if (i == 03) {
      return _monthsOfYear[2];
    }
    if (i == 04) {
      return _monthsOfYear[3];
    }
    if (i == 05) {
      return _monthsOfYear[4];
    }
    if (i == 06) {
      return _monthsOfYear[5];
    }
    if (i == 07) {
      return _monthsOfYear[6];
    }
    if (i == 08) {
      return _monthsOfYear[7];
    }
    if (i == 09) {
      return _monthsOfYear[8];
    }
    if (i == 10) {
      return _monthsOfYear[9];
    }
    if (i == 11) {
      return _monthsOfYear[10];
    }
    if (i == 12) {
      return _monthsOfYear[11];
    }
    throw new Exception("no es ningun dia de la semana");
  }
          ...
          child: new ListView(
            ...
            children: <Widget>[
              ...
              new Container(
                  ...
                  child: new Text("1. ¿Tiene usted problemas con su memoria?",
              ...
              new InputDecorator(
                ...
                child: new DropdownButton<String>(
                  ...
                  items: DEPTOS_CIUDADES[_depto].map((String value) {
                    return new DropdownMenuItem<String>(
                      value: value,
                      child: new Text(value),
                    );
              ...
              new TextField(
                  ...
                  decoration: new InputDecoration(hintText: 'Ocupación'),
                  onChanged: (String str) {
                    setState(() {
                      _ocupacion = str;
                    });
              ...
              new Container(
                  padding: new EdgeInsets.only(
                      right: 0.0, top: 20.0, left: 0.0, bottom: 0.0),
                  child: new Text("1. ¿Qué fecha es hoy?",
                      style: new TextStyle(fontSize: 18.0))),
              new _DateTimePicker(
                labelText: 'Fecha',
              ...
              new Container(
                  padding: new EdgeInsets.only(
                      right: 0.0, top: 20.0, left: 0.0, bottom: 0.0),
                  child: new Text("2. ¿Qué día de la semana es hoy?",
                      style: new TextStyle(fontSize: 18.0))),
              new InputDecorator(
                decoration: const InputDecoration(
                  labelText: 'Dia',
              ...
              new Container(
                  padding: new EdgeInsets.only(
                      right: 0.0, top: 20.0, left: 0.0, bottom: 0.0),
                  child: new Text("3. ¿En qué mes estamos?",
                      style: new TextStyle(fontSize: 18.0))),
              new InputDecorator(
                decoration: const InputDecoration(
                  labelText: 'Mes',
              ...
              new Container(
                  padding: new EdgeInsets.only(
                      right: 0.0, top: 20.0, left: 0.0, bottom: 0.0),
                  child: new Text("4. ¿En qué año estamos?",
                      style: new TextStyle(fontSize: 18.0))),
              new InputDecorator(
                decoration: const InputDecoration(
                  labelText: 'Año',
              ...
              new Container(
                  padding: new EdgeInsets.only(
                      right: 0.0, top: 20.0, left: 0.0, bottom: 0.0),
                  child: new Text("5. ¿Que día del mes es hoy?",
                      style: new TextStyle(fontSize: 18.0))),
              new InputDecorator(
                decoration: const InputDecoration(
                  labelText: 'Día',
              ...
              new Container(
                  padding: new EdgeInsets.only(top: 60.0),
                  child: new Text("Resolución de problemas:",
                      style: new TextStyle(
                          fontWeight: FontWeight.bold, fontSize: 25.0))),
              new Container(
                  padding: new EdgeInsets.only(
              ...
              new Container(
                  padding: new EdgeInsets.only(
                      right: 0.0, top: 20.0, left: 0.0, bottom: 0.0),
                  child: new Text("4.  ¿Cuál de estas no pertenece a la lista?",
                      style: new TextStyle(fontSize: 18.0))),
              new InputDecorator(
                decoration: const InputDecoration(
                  labelText: 'Opciones',
