...
class _ExamenInformanteState extends State<ExamenInformante> {
  ...
  final List<String> _yesNo = <String>[
    'Si', 'No'
  ];

  final List<String> _yesNose = <String>[
    'Si', 'No', 'No sé'
  ];
  ...
  final List<String> _yesAplica = <String>[
    'Si', 'No', 'No aplica'
  ];

  final List<String> _mente = <String>[
    'Generalmente', 'A veces', 'Raramente o nunca'
  ];

  final List<String> _menteNose = <String>[
    'Generalmente', 'A veces', 'Raramente o nunca', 'No sé'
  ];

  final List<String> _menteNoseAplica = <String>[
    'Generalmente', 'A veces', 'Raramente o nunca', 'No sé', 'No aplica'
  ];
  ...
  final List<String> _perdida = <String>[
    'Sin pérdida', 'Algo de pérdida', 'Pérdida severa'
  ];
                ...
                children: <Widget>[
                  ...
                  new Container(
                      ...
                      child: new Text(
                          "1. la fecha del día?",
                          style: new TextStyle(fontSize: 18.0))),
                  new Container(padding: new EdgeInsets.only(left: 20.0),
                      child:
                      new InputDecorator(
                          decoration: const InputDecoration(
                            labelText: 'Respuesta:',
                  ...
                  new Container(padding: new EdgeInsets.only(top: 60.0),
                      child: new Text(
                          "Actividades comunitarias:", style: new TextStyle(
                          fontWeight: FontWeight.bold, fontSize: 25.0))),
                  new Container(padding: new EdgeInsets.only(top: 10.0),
                      child: new Text(
                          "1. ¿Él/Ella sigue trabajando?",
                          style: new TextStyle(fontSize: 18.0))),
                  new InputDecorator(
                      decoration: const InputDecoration(
                        labelText: 'Respuesta:',
                  ...
                  new Container(padding: new EdgeInsets.only(top: 10.0),
                      child: new Text(
                          "4. ¿Condujo él/ella alguna vez un carro?",
                          style: new TextStyle(fontSize: 18.0))),
                  new InputDecorator(
                      decoration: const InputDecoration(
                        labelText: 'Respuesta:',
                  ...
                  new Container(
                      padding: new EdgeInsets.only(top: 10.0, left: 20.0),
                      child: new Text(
                          "4a. ¿Actualmente, él/ella conduce un carro?",
                          style: new TextStyle(fontSize: 18.0))),
                  new Container(
                      padding: new EdgeInsets.only(top: 10.0, left: 20.0),
                      child: new InputDecorator(
